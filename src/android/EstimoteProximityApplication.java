...
public class EstimoteProximityApplication extends Application implements BootstrapNotifier {
    ...
    public void onCreate() {
		...
		beaconManager.setRegionStatePeristenceEnabled(false); // only use when debugging, possible for user to get multiple launches in location
		Log.i(TAG, "background between scans: "+beaconManager.getBackgroundBetweenScanPeriod());
        // wake up the app when any beacon is seen (you can specify specific id filers in the parameters below)
        Region region = new Region("com.zackhable.estimote.beaconRegion", Identifier.parse("E1F54E02-1E23-44E0-9C3D-512EB56ADEC9"), null, null);
